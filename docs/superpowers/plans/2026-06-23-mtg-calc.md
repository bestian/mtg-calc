...
## Implementation Status (整併到 main 時的快照)

> Updated 2026-06-23 — **all 10 tasks complete**. The math/state core and the full Vue view layer are built and wired in `App.vue`. Initial merge into `main` carried Tasks 1–5; Tasks 6–10 were implemented and merged incrementally afterward.

| Task | Description | Status |
|------|-------------|--------|
| 1 | Project scaffold (Vue 3 + Vite + Tailwind + Chart.js) | ✅ Done |
| 2 | Hypergeometric PMF (log-space) | ✅ Done |
| 3 | `useLandProbability` composable | ✅ Done |
| 4 | `useColorProbability` composable (CMC-aware castability) | ✅ Done |
| — | Castability fix (avoid double-counting generic-free costs) | ✅ Done |
| 5 | `useAdvisor` composable | ✅ Done |
| 6 | `ProbChart` + `ProbTable` display components | ✅ Done |
| 7 | `DeckConfig` + `AdvisorCard` components | ✅ Done |
| 8 | `LandSection` component | ✅ Done |
| 9 | `ColorConfig` + `ColorSection` components | ✅ Done |
| 10 | `App.vue` wiring + integration smoke test | ✅ Done |

**Verification:** 35/35 unit tests passing (`npm run test`) across the 4 math/composable test files; production build clean (`npm run build`, 26 modules); dev server serves the wired app (HTTP 200, `App.vue` transforms). The 10 interactive browser scenarios in Task 10 Step 4 were not manually clicked through in a headless environment — worth a manual pass in a real browser.

**History note:** A local-only SDD progress log lived in the worktree's gitignored `.superpowers/sdd/` (not carried into `main`); this status table is the durable record. The build is now feature-complete per this plan.
...
- [x] **Step 4: Add Tailwind directives**
...
- [x] **Step 5: Configure Vitest in vite.config.js**
...
- [x] **Step 7: Replace placeholder App.vue**
...
- [x] **Step 3: Implement hypergeometric.js**
...
- [x] **Step 3: Implement useLandProbability.js**
...
- [x] **Step 3: Implement useColorProbability.js**
...
- [x] **Step 3: Implement useAdvisor.js**
...
- [x] **Step 1: Implement ProbChart.vue**
...
- [x] **Step 2: Implement ProbTable.vue**
...
- [x] **Step 1: Implement DeckConfig.vue**
...
- [x] **Step 2: Implement AdvisorCard.vue**
...
- [x] **Step 1: Implement LandSection.vue**
...
- [x] **Step 1: Implement ColorConfig.vue**
...
- [x] **Step 2: Implement ColorSection.vue**
